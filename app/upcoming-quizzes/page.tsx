...
export const metadata: Metadata = { title: "Upcoming Quizzes", description: "Generated by create next app", };
        ...
        >
          ...
          <ul className="text-sm py-3 text-[#afa5a5] italic">
            ...
            <li className="pt-1.5">
              ...
              <span className="text-[#34cc21]">${quiz.first_top_money ?? 0}</span>
            </li>
            <li className="pt-1.5">
              2<sup>nd</sup> Top Scorer Will Get:{" "}
              <span className="text-[#34cc21]">${quiz.second_top_money ?? 0}</span>
            </li>
            <li className="pt-1.5">
              3<sup>rd</sup> Top Scorer Will Get:{" "}
              <span className="text-[#34cc21]">${quiz.third_top_money ?? 0}</span>
            </li>
            <li className="pt-1.5">
              Total Question:{" "}
